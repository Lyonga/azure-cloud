locals {
  ...
  workspace_name                 = terraform.workspace == "default" ? "demo-infra-np1" : terraform.workspace
  resolved_location              = coalesce(var.location, local.default_location)
  default_resource_group_name    = "rg-lyonga-azure-np1-eus-01"
  default_function_app_name      = "func-lyonga-azure-np1-eus-01"
  default_app_service_plan_name  = "asp-lyonga-azure-np1-eus-01"
  default_storage_account_name   = "stlyongaaznp1eus01"
